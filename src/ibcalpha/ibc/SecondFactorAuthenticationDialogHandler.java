...
class SecondFactorAuthenticationDialogHandler implements WindowHandler {
    ...
    private void selectSecondFactorDevice(Window window) {
        ...
        String secondFactorDevice = Settings.settings().secondFactorDevice();
        if (secondFactorDevice == null) {
